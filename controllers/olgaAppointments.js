...
const olgaAppointmentController = {
    all(req, res) {
        // Returns all appointments

        OlgaAppointment.find({}).exec((err, appointments) => res.json(appointments));
    },
    create(req, res) {
        ...
        var newappointment = new OlgaAppointment({
            name: name,
        ...
        newappointment.save((err, saved) => {
            ...
            OlgaAppointment.find({ _id: saved._id })
    ...
    delete(req, res) {
        OlgaAppointment.deleteOne({ phone: req.body.phone || req.headers.phone }, function (err) {
            if (err) {
                console.log(err);
            } else {
...
module.exports = olgaAppointmentController;